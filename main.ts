function display64 (text: string) {
    ...
    matrix.imageArrayDigit(matrix.matrix_text(text))
...
loops.everyInterval(1000, function () {
    ...
    matrix.writeDigits(6, 0, 15, rtcpcf85063tp.getTime(rtcpcf85063tp.ePart.mit), matrix.eAlign.links, 16, 0, matrix.eTransparent.u, matrix.matrix_eFaktor(matrix.eFaktor.f2))
